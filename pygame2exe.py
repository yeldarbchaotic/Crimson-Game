...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Crimson.py"

        #Name of program
        self.project_name = "Crimson"

        #Project url
        self.project_url = "https://github.com/yeldarbchaotic/Crimson-Game"
        ...
        #Auhor of program
        self.author_name = "yeldarbchaotic"
        self.author_email = "yeldarbchaotic@yahoo.com"
        self.copyright = ""

        #Description
        self.project_description = "Crimson - A Game by Crimson Industries!"

        #Icon file (None will use pygame default icon)
        self.icon_file = ".\\images\\Crimson.ico"
